                ...
                <div className="col-7">
                  <div className="Product_Detail mt-3">
                    ...
                    <p className="Product_Exn mt-3">
                      Magnetic Net with Stainless Steel Mesh is considered to be
                      the best option for allowing entry of natural light while
                      keeping the door locked. It is ideal for use in
                      ...
                      during new construction & renovation. Openable Door system
                      with Stainless Steel Mesh has been equipped with high
                      quality metal hinges that ensure smooth & silent movement.
                    </p>
          ...
          <>
            ...
            <div className="col-12 mt-5">
              ...
              <p className="Product_Exn mt-3">
                ...
                the door locked. It is ideal for use in residential apartments,
                bungalows, and houses. This is a type of double door system
                which comprises one normal & one mesh door. It can be installed
                in hassle-free manner during new construction & renovation.
                Openable Door system with Stainless Steel Mesh has been equipped
                with high quality metal hinges that ensure smooth & silent
                movement.
              </p>
              <p className="Product_Feature mt-5">Features</p>
              <ul>
