  ...
  return (
    <>
      <div className="RollerDr">
              ...
              <div className="row mt-5 cards_row">
                ...
                <div className="col-7">
                  <div className="Product_Detail mt-3">
                    <h5 className="Product_Name">Multi Sliding Door System</h5>
                    <h5 className="Square">
                    ...
                    <p className="Product_Exn mt-3">
                      It is made out of 2Aluminium Profile with Stainless Steel
                      mesh It has Felt Grove to arrest gaps in the contact
                      surface It is assembled with double screw Joints to avoid
                      breakage in the edges and Twist in the frame It is
                      advisable to fix this kind of Sliding door, to your UPVC
                      Multi Sliding doors and Aluminium Multi Sliding Doors
                    </p>
        ...
        {pricecard && (
          <>
            <PriceCard PriceCardTitle="Get a price quote for Mutli Sliding Door System "></PriceCard>
          </>
        )}
          ...
          <>
            <div className="row cards_row mt-5">
              <div className="col-12 mt-3">
                <h5 className="Product_Name ms-3">Multi Sliding Door System</h5>
            ...
            <div className="col-12 mt-5">
              <h5 className="product_des mt-4">product description</h5>
              <h5 className="Product_Title mt-4">Multi Sliding Door System </h5>
              <p className="Product_Exn mt-3">
                ...
                edges and Twist in the frame It is advisable to fix this kind of
                Sliding door, to your UPVC Multi Sliding doors and Aluminium
                Multi Sliding Doors
              </p>
