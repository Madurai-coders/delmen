              ...
              <div className="row mt-5 cards_row">
                ...
                <div className="col-7">
                  <div className="Product_Detail mt-3">
                    <h5 className="Product_Name">Retractable Roller Window</h5>
                    ...
                    <p className="Product_Exn mt-3">
                      ...
                      advantage of this product it can be used as in need if not
                      it will be in the roll form inside the net box This
          ...
          <>
            ...
            <div className="col-12 mt-5">
              ...
              <p className="Product_Exn mt-3">
                ...
                this product it can be used as in need if not it will be in the
                roll form inside the net box This Product comes with Fiberglass
                Stiff mesh only
              </p>
              <h5 className="Product_Title mt-4">Retractable Roller Window </h5>
              <p className="Product_Exn mt-3">
