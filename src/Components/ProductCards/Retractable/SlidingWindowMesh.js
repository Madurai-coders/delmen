...
import Slidingwindow from "../../../assets/CardsImg/slidingwindow.png";
              ...
              <div className="row mt-5 cards_row">
                ...
                <div className="col-7">
                  <div className="Product_Detail mt-3">
                    <h5 className="Product_Name">Sliding Window Mesh System</h5>
                    <h5 className="Square">
                    ...
                    <p className="Product_Exn mt-3">
                      ...
                      has Felt Grove to arrest gaps in the contact surface It is
                      assembled with double screw Joints to avoid breakage in
                      the edges and Twist in the frame It is advisable to fix
                      this kind of Sliding Windows, to your UPVC sliding windows
                      as well aluminium sliding systems
                    </p>
              ...
              <div className="row">
                ...
                <div className="col-12 text-center">
                  <h5 className="Card_Title mt-5">
                    Get A Price Quote For Sliding Window Mesh System
                  </h5>
                </div>
          ...
          <>
            ...
            <div className="col-12 mt-5">
              ...
              <p className="Product_Exn mt-3">
                ...
                Felt Grove to arrest gaps in the contact surface It is assembled
                with double screw Joints to avoid breakage in the edges and
                Twist in the frame It is advisable to fix this kind of Sliding
                Windows, to your UPVC sliding windows as well aluminium sliding
                systems
              </p>
